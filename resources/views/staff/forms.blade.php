...
<div class="relative min-h-screen py-8 px-4 sm:px-6 lg:px-8">
    ...
    @if((optional(auth()->user()->role)->level ?? 0) < 2 && !auth()->user()->isAdmin())
        <div class="relative max-w-4xl w-full mx-auto mt-20 text-center">
            <div class="backdrop-blur-xl border-2 border-red-400/60 rounded-2xl shadow-2xl p-8 md:p-12 bg-red-900/40">
                ...
                <a href="{{ route('staff.dashboard') }}" class="inline-flex items-center px-6 py-3 bg-red-600 hover:bg-red-700 text-white font-bold rounded-xl transition-all duration-300 transform hover:scale-105 shadow-lg">
                                    ...
                                    <td class="px-6 py-4">
                                        ...
                                        <div class="flex flex-col sm:flex-row gap-2">
                                            ...
                                            @if($form->status === 'pending')
                                                ...
                                                <form method="POST" action="{{ route('staff.forms.cancel', $form->id) }}" onsubmit="return confirm('Yakin ingin membatalkan formulir ini? (Sesi/Antrian akan hangus)');" class="inline mt-2 sm:mt-0">
                                                    @csrf
