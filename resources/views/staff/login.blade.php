        ...
        ">
            <form class="space-y-6" method="POST" action="{{ route('staff.login.post') }}" id="loginForm">
                ...
                <div class="text-center space-y-3">
                    <div>
                        <a href="{{ route('staff.register') }}" class="inline-flex items-center px-6 py-3 rounded-2xl font-semibold text-white bg-[linear-gradient(135deg,#10b981,#059669)] shadow-[0_16px_36px_rgba(16,185,129,0.30)] hover:shadow-[0_20px_44px_rgba(16,185,129,0.40)] transition-all duration-300">
                            <i class="fas fa-user-plus mr-2"></i>Daftar Staf Baru
                        </a>
                    </div>
                    <div>
                        <a href="{{ route('public.index') }}" class="text-sky-600 hover:text-sky-500 font-medium transition-colors">
