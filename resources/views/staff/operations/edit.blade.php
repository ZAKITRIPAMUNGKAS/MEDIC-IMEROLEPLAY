            ...
            <div class="section-card">
                ...
                <div class="space-y-4">
                    <div>
                        ...
                        <textarea name="diagnosa" rows="3" class="form-input-dark" placeholder="Keluhan utama dan keluhan penyerta pasien..." required>{{ old('diagnosa', $operation->diagnosa) }}</textarea>
                    </div>
            ...
            <div class="section-card">
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <textarea name="medical_details[tindakan][langkah_tindakan]" rows="4" class="form-input-dark" 
                                  placeholder="- Pasien diposisikan supine&#10;- Desinfeksi lapangan operasi&#10;- Insisi kulit dan eksplorasi...">{{ old('medical_details.tindakan.langkah_tindakan', $med['tindakan']['langkah_tindakan'] ?? '') }}</textarea>
                    </div>

                    <div>
                        <label class="block text-sky-200 text-sm font-semibold mb-2">Hasil Operasi & Intraperatif</label>
                        <textarea name="hasil_operasi" rows="2" class="form-input-dark" placeholder="Operasi berjalan lancar, perdarahan minimal...">{{ old('hasil_operasi', $operation->hasil_operasi) }}</textarea>
                    </div>
                </div>
            </div>
