    ...
    <div class="relative z-10 px-4 py-8 sm:px-6 lg:px-8 text-white">
        <div class="max-w-2xl mx-auto">
            ...
            <div class="glass-effect rounded-2xl elegant-shadow-lg p-8">
                <form method="POST" action="{{ route('staff.register.post') }}" enctype="multipart/form-data" class="space-y-6">
                    @csrf
                        ...
                        <div class="relative">
                            <select id="role_id" name="role_id" required
                                ...
                                @foreach($roles as $role)
                                    <option value="{{ $role->id }}" @selected(old('role_id') == $role->id) class="bg-slate-900 text-white font-bold">
