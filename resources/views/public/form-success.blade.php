...
@section('title', 'Formulir Berhasil Dikirim - Portal Medis MOTIONLIFE')
        ...
        <div class="card bg-white/98 backdrop-blur-lg shadow-2xl border border-white/30 rounded-3xl p-12 text-center animate-fade-in-up overflow-hidden">
            ...
            <div class="mb-8">
                ...
                <p class="text-2xl text-slate-700 mb-4 font-medium">
                    Terima kasih, <span class="font-bold text-sky-600 bg-sky-50 px-3 py-1 rounded-full">{{ $form->character_name }}</span>
                </p>
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            <div class="flex justify-between mb-1">
                                ...
                                <span class="text-sm font-bold text-indigo-900">{{ $form->form_data['pss_score'] ?? 0 }}/40</span>
                            </div>
                        ...
                        <div>
                            <div class="flex justify-between mb-1">
                                ...
                                <span class="text-sm font-bold text-indigo-900">{{ $form->form_data['rses_score'] ?? 0 }}/40</span>
                            </div>
                            <div class="w-full bg-indigo-200 rounded-full h-2.5">
                                @php 
            ...
            <div class="bg-gradient-to-br from-amber-50 via-yellow-50 to-orange-50 rounded-3xl p-8 mb-8 border-2 border-amber-200 shadow-lg">
                ...
                <form method="POST" action="{{ route('public.form.testimoni', $form->id) }}" id="testimoniForm" class="space-y-6">
                    @csrf
                    <div>
                        ...
                        <div class="flex justify-center gap-2 mb-2" id="ratingStars">
                            @for($i = 5; $i >= 1; $i--)
                                ...
                                <label for="rating{{ $i }}" class="cursor-pointer text-4xl text-gray-300 hover:text-yellow-400 transition-colors duration-200 rating-star" data-rating="{{ $i }}">
                        ...
                        <div class="group p-5 bg-white/90 rounded-2xl border border-sky-100 hover:border-sky-200 transition-all duration-300 hover:shadow-md">
                            <div class="flex items-center justify-between">
                                ...
                                <span class="font-mono text-lg font-bold text-sky-600 bg-sky-100 px-3 py-1 rounded-full">
                                    #{{ str_pad($form->id, 6, '0', STR_PAD_LEFT) }}
                                </span>
                            </div>
                        </div>
                        <div class="group p-5 bg-white/90 rounded-2xl border border-sky-100 hover:border-sky-200 transition-all duration-300 hover:shadow-md">
                            <div class="flex items-center justify-between">
                                ...
                                <span class="font-bold text-slate-900">{{ $form->character_name }}</span>
                            </div>
                        </div>
                        @if($form->citizen_id)
                        <div class="group p-5 bg-white/90 rounded-2xl border border-sky-100 hover:border-sky-200 transition-all duration-300 hover:shadow-md">
                            <div class="flex items-center justify-between">
                                ...
                                <span class="font-bold text-slate-900">{{ $form->citizen_id }}</span>
                            </div>
                        </div>
                        @endif
                    </div>
                    <div class="space-y-4">
                        <div class="group p-5 bg-white/90 rounded-2xl border border-sky-100 hover:border-sky-200 transition-all duration-300 hover:shadow-md">
                            <div class="flex items-center justify-between">
                                ...
                                <span class="font-bold text-slate-900">{{ ucfirst(str_replace('_', ' ', $form->form_type)) }}</span>
                            </div>
                        </div>
                        <div class="group p-5 bg-white/90 rounded-2xl border border-sky-100 hover:border-sky-200 transition-all duration-300 hover:shadow-md">
                            <div class="flex items-center justify-between">
                        ...
                        <div class="group p-5 bg-white/90 rounded-2xl border border-sky-100 hover:border-sky-200 transition-all duration-300 hover:shadow-md">
                            <div class="flex items-center justify-between">
                                ...
                                <span class="font-bold text-slate-900">{{ $form->created_at->setTimezone('Asia/Jakarta')->format('d/m/Y H:i') }} WIB</span>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="flex flex-col sm:flex-row gap-6 justify-center mb-8">
                ...
                <a href="{{ route('public.form', $form->form_type) }}" class="group relative px-8 py-4 bg-white text-sky-600 text-lg font-bold rounded-2xl border-2 border-sky-500 shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300 overflow-hidden">
