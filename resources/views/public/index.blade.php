                ...
                <div id="testimonial-container" class="relative max-w-7xl mx-auto">
                    <div class="columns-1 md:columns-2 lg:columns-3 gap-6 space-y-6">
                        @foreach($testimonials as $index => $testimoniItem)
                            <div class="break-inside-avoid animate-fade-in-up" style="animation-delay: {{ $index * 100 }}ms">
                                <div class="relative group">
                                    <div
                                    ...
                                    <div
                                        ...
                                        <div class="flex items-start gap-4 mb-4">
                                            ...
                                            <div>
                                                <h4 class="text-white font-bold text-sm">{{ $testimoniItem->character_name }}</h4>
                                                <p class="text-sky-400 text-xs uppercase tracking-wider">Warga Los Santos</p>
                                                <div class="flex items-center gap-1 mt-1">
                                                    @for($i = 1; $i <= 5; $i++)
                                                        <i
                                                            class="fas fa-star text-[10px] {{ $i <= $testimoniItem->rating ? 'text-amber-400' : 'text-slate-600' }}"></i>
                                                    @endfor
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div
                                            ...
                                            <span>{{ $testimoniItem->created_at->diffForHumans() }}</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
