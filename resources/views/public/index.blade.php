                ...
                <div id="testimonial-container" class="relative max-w-6xl mx-auto perspective-1000">
                    ...
                    <div class="relative z-20 transition-all duration-500 ease-out" id="slides-container">
                        @foreach($testimonials as $index => $testimoniItem)
                            <div class="testimoni-slide w-full flex items-center justify-center transition-all duration-700 ease-out {{ $index === 0 ? 'relative z-20 opacity-100 scale-100 translate-y-0' : 'absolute top-0 left-0 z-10 opacity-0 scale-95 translate-y-8 pointer-events-none' }}"
                                data-index="{{ $index }}">
                                <!-- Advanced Glass Card -->
                                                ...
                                                <div class="relative group/avatar">
                                                    ...
                                                    <div class="absolute -bottom-5 left-1/2 -translate-x-1/2 bg-gradient-to-r from-cyan-500 to-blue-500 text-white text-[9px] uppercase font-bold px-2.5 py-0.5 rounded-full border-[3px] border-slate-900 shadow-xl flex items-center gap-1 animate-fade-in-up z-20 whitespace-nowrap"
                                                            ...
                                                            <div
                                                                ...
                                                                @for($i = 1; $i <= 5; $i++)
                                                                    <i
                                                                        class="fas fa-star text-[10px] {{ $i <= $testimoniItem->rating ? 'text-amber-400 drop-shadow-glow' : 'text-slate-600' }}"></i>
                                                                @endfor
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="text-center md:text-left space-y-6">
                                                            <blockquote
                                                                ...
                                                                <span class="italic text-slate-200">"{{ $testimoniItem->testimoni }}"</span>
                                                            </blockquote>
                            ...
                            @if($testimonials->count() > 1)
                                <div class="relative z-30 mt-12 flex items-center justify-center gap-8">
                                    ...
                                    <div
                                        ...
                                        @foreach($testimonials as $index => $testimoniItem)
                                            <button
                                                class="testimoni-dot w-2.5 h-2.5 rounded-full transition-all duration-500 {{ $index === 0 ? 'bg-sky-400 w-10 shadow-[0_0_15px_rgba(56,189,248,0.8)]' : 'bg-white/10 hover:bg-white/30' }}"
