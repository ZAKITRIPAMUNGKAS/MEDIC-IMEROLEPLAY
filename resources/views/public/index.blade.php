                                    ...
                                    <div
                                        ...
                                        <div class="relative z-10">
                                            ...
                                            <div class="flex items-center gap-1 mb-6">
                                                @for($i = 1; $i <= 5; $i++)
                                                    <i
                                                        class="fas fa-star text-2xl {{ $i <= $testimoniItem->rating ? 'text-amber-500' : 'text-slate-300' }}"></i>
                                                @endfor
                                            </div>
                                            ...
                                            <div class="flex items-center gap-4 pt-6 border-t border-slate-200">
                                                ...
                                                <div>
                                                    <h4 class="text-slate-900 font-bold text-lg">{{ $testimoniItem->character_name }}
                                                    </h4>
