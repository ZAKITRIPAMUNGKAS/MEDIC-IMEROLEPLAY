            ...
            <form action="{{ route('admin.organizational-structure.store') }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <select name="hospital_type" id="hospital_type" required
                        class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
                        <option value="ems" {{ old('hospital_type') === 'ems' ? 'selected' : '' }}>EMS (Emergency Medical
                            Services)</option>
                        <option value="roxwood" {{ old('hospital_type') === 'roxwood' ? 'selected' : '' }}>Roxwood Hospital
                        </option>
                    </select>
                </div>
                ...
                <div class="mb-4">
                    ...
                    <textarea name="structure_data" id="structure_data" rows="15" required
                        class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 font-mono text-sm">{{ old('structure_data', '{}') }}</textarea>
                ...
                <div class="mb-4">
                    ...
                    <textarea name="required_names" id="required_names" rows="10"
                        class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                        placeholder="Masukkan satu nama per baris&#10;Oliver Januari&#10;Joseph Preistley&#10;Jehan L. Keenan">{{ old('required_names') }}</textarea>
                    <p class="text-sm text-gray-500 mt-1">
