...
@section('title', 'Tambah Atur Gaji')
...
<div class="relative min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
    ...
    <div class="relative max-w-4xl w-full mx-auto">
        <div class="glass-effect rounded-2xl elegant-shadow-lg p-4 sm:p-6 md:p-8 lg:p-12">
            ...
            <form method="POST" action="{{ route('admin.salary-settings.store') }}">
                @csrf
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                        ...
                        <div class="sm:col-span-2">
                            ...
                            <textarea id="description" name="description" rows="3"
                                      ...
                                      placeholder="Tambahkan deskripsi untuk role ini">{{ old('description') }}</textarea>
                            @error('description')
                                <p class="form-error">{{ $message }}</p>
                            @enderror
                        </div>
