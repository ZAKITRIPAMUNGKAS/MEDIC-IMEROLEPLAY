<?php $__env->startSection('title', 'Tambah Atur Gaji'); ?>
    ...
    <div class="relative max-w-4xl w-full mx-auto">
        <div class="glass-effect rounded-2xl elegant-shadow-lg p-4 sm:p-6 md:p-8 lg:p-12">
            <div class="text-center mb-6 sm:mb-8 md:mb-10">
                <h1 class="text-2xl sm:text-3xl md:text-4xl font-bold text-white mb-2">Tambah Atur Gaji</h1>
                <p class="text-blue-100 text-sm sm:text-base font-medium">Buat atur gaji baru untuk role tertentu</p>
            </div>
            <form method="POST" action="<?php echo e(route('admin.salary-settings.store')); ?>">
                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>">
                                    ...
                                    <?php $__currentLoopData = $roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($role->name); ?>" 
                                                <?php echo e(old('role_name') == $role->name ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>"
                                       ...
                                       value="<?php echo e(old('weekly_salary')); ?>">
                                <div class="absolute inset-y-0 right-0 flex items-center pr-4">
                                    <span class="text-gray-300 font-medium">$</span>
                                </div>
                            </div>
                            <?php $__errorArgs = ['weekly_salary'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>"
                                      placeholder="Tambahkan deskripsi untuk role ini"><?php echo e(old('description')); ?></textarea>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\website\EMS-IME\public_html\resources\views\admin\salary-settings\create.blade.php ENDPATH**/ ?>