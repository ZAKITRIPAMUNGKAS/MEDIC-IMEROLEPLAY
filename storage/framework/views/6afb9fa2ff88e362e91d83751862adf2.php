...
<?php $__env->startSection('content'); ?>
    ...
    <div class="min-h-screen bg-gradient-to-br from-sky-900 via-sky-800 to-sky-700 relative overflow-hidden">
        ...
        <div class="relative z-10 px-4 py-8 sm:px-6 lg:px-8 text-white">
            ...
            <?php if(isset($anyActiveSession) && $anyActiveSession && !isset($activeSession)): ?>
            ...
            <div class="flex flex-col gap-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <?php if(!empty($accumulatedEmsHours)): ?>
                        <div class="card backdrop-blur-xl border-2 border-sky-400/60 rounded-3xl shadow-2xl elegant-card elegant-stagger"
                            style="background-color: rgba(7, 89, 133, 0.9);">
                            <div class="p-5 sm:p-6">
                                <div class="flex items-center justify-between mb-4">
                ...
                <div class="card backdrop-blur-xl border-2 border-sky-400/60 rounded-3xl shadow-2xl elegant-card elegant-stagger"
                    ...
                    <div class="p-6 sm:p-8">
                        <?php if(isset($todaySessions) && $todaySessions->count() > 0): ?>
                            <div class="space-y-3 max-h-60 overflow-y-auto custom-scrollbar pr-2">
                                <?php $__currentLoopData = isset($todaySessions) ? $todaySessions : []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $session): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="card backdrop-blur-xl border-2 border-sky-400/60 rounded-3xl shadow-2xl elegant-card elegant-stagger"
                    ...
                    <div class="p-6 sm:p-8 space-y-4">
                        <?php $__empty_1 = true; $__currentLoopData = $leaderboard; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $staff): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <div
                                    ...
                                    <div class="flex items-center space-x-3 sm:space-x-4">
                                        ...
                                        <div class="flex-1">
                                            <div class="flex items-center space-x-2 mb-1">
                                                ...
                                                <?php if(isset($staff->total_juara_1_count) && $staff->total_juara_1_count > 0): ?>
                                                    <div
                            ...
                            <tbody class="divide-y divide-sky-400/20">
                                <?php $__empty_1 = true; $__currentLoopData = $recentAppointments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $appointment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    ...
                                    <tr class="hover:bg-sky-700/40 transition-all duration-300">
                                        ...
                                        <td
                                            class="px-4 sm:px-8 py-5 sm:py-6 whitespace-nowrap text-sm text-sky-300 font-medium">
                                            <?php if($appointmentDate && $appointmentTime): ?>
                                        ...
                                        <td
                                            class="px-4 sm:px-8 py-5 sm:py-6 whitespace-nowrap text-sm text-sky-300 font-medium">
                                            <?php if($appointment->processedBy && $appointment->status !== 'pending'): ?>
                                                <div class="flex flex-col">
                                                    <span
                                                        class="font-semibold text-white"><?php echo e($appointment->processedBy->name); ?></span>
                                                    <?php if($appointment->processed_at): ?>
                                                        <span
    ...
    <div id="toastContainer"
        class="fixed top-32 left-0 right-0 z-[100000] flex flex-col items-center gap-3 pointer-events-none">
    </div>
