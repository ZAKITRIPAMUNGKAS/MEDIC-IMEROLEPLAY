        ...
        <div class="relative z-10 px-4 py-8 sm:px-6 lg:px-8 text-white">
            ...
            <div class="flex flex-col gap-8">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(optional(auth()->user()->role)->name !== 'perawat' && optional(auth()->user()->role)->name !== 'trainee'): ?>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->user()->isAdmin() || in_array(optional(auth()->user()->role)->name, ['dokter_umum', 'dokter_spesialis'])): ?>
