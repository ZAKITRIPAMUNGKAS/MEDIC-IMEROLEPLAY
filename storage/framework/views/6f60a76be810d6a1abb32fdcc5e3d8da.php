                                        ...
                                        <div class="relative grid md:grid-cols-[auto,1fr] gap-10 md:gap-16 items-center">
                                            ...
                                            <div class="flex flex-col items-center gap-6">
                                                <div class="relative group/avatar">
                                                    ...
                                                    <!-- Badge -->
                                                    <div class="absolute -bottom-4 left-1/2 -translate-x-1/2 bg-gradient-to-r from-cyan-500 to-blue-500 text-white text-[10px] uppercase font-bold px-3 py-1 rounded-full border-[3px] border-slate-900 shadow-xl flex items-center gap-1 animate-fade-in-up z-20 whitespace-nowrap"
                                                        style="animation-duration: 0.8s;">
                                                        <i class="fas fa-check-circle text-white/90"></i> Verified
                                                    </div>
                                                </div>

                                                <!-- Rating Stars (With margin top to clear badge) -->
                                                <div
                                                    class="flex gap-1 items-center bg-black/20 px-3 py-1.5 rounded-full border border-white/5 backdrop-blur-sm mt-3">
                                                    <?php for($i = 1; $i <= 5; $i++): ?>
                                                        <i
                                                            class="fas fa-star text-sm <?php echo e($i <= $testimoniItem->rating ? 'text-amber-400 drop-shadow-glow' : 'text-slate-600'); ?>"></i>
                                                    <?php endfor; ?>
                                                </div>
                                            </div>
