...
unset($__errorArgs, $__bag); ?>" required>
                                <?php $__errorArgs = ['form_data.birth_date'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <p class="form-error"><?php echo e($message); ?></p> <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" required>
                                ...
                                <?php $__errorArgs = ['form_data.gender'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <p class="form-error"><?php echo e($message); ?></p> <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                ...
                                <?php $__errorArgs = ['form_data.occupation'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <p class="form-error"><?php echo e($message); ?></p> <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                ...
                                <?php $__errorArgs = ['form_data.phone_number'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <p class="form-error"><?php echo e($message); ?></p> <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="mb-8">
                        <h3 class="text-xl font-bold text-white mb-6">
                            <?php if($type === 'pendaftaran_karakter'): ?>
...
unset($__errorArgs, $__bag); ?>" required>
                                    ...
                                    <?php $__errorArgs = ['form_data.doctor_name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <p class="form-error"><?php echo e($message); ?></p> <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                    ...
                                    <?php $__errorArgs = ['form_data.photo_ktp'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <p class="form-error"><?php echo e($message); ?></p> <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                        accept="image/*" required>
                                    <?php $__errorArgs = ['form_data.photo_skb'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <p class="form-error"><?php echo e($message); ?></p> <?php unset($message);
                            ...
                            <?php elseif($type === 'tes_psikologi'): ?>
                                <div class="mb-6">
                                    ...
                                    <div class="mb-8">
                                        ...
                                        <?php $__currentLoopData = $bigfive_questions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $question): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div
                                    ...
                                    <div class="mb-8">
                                        ...
                                        <?php $__currentLoopData = $stress_questions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $question): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div
                                                class="mb-6 p-6 bg-white/5 rounded-xl border border-white/10 hover:border-sky-500/30 transition-all duration-300">
                                                <p class="text-white mb-4 font-medium text-lg"><?php echo e($i + 1); ?>. <?php echo e($question); ?></p>
                                    ...
                                    <div class="mb-8">
                                        ...
                                        <?php $__currentLoopData = $esteem_questions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $question): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div
                                                class="mb-6 p-6 bg-white/5 rounded-xl border border-white/10 hover:border-sky-500/30 transition-all duration-300">
                                                <p class="text-white mb-4 font-medium text-lg"><?php echo e($i + 1); ?>. <?php echo e($question); ?></p>
...
unset($__errorArgs, $__bag); ?>"
                                            required>
                                        <?php $__errorArgs = ['form_data.appointment_date'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>"
                                            required>
                                        <?php $__errorArgs = ['form_data.appointment_time'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <p class="form-error text-xs mt-1"><?php echo e($message); ?>
...
unset($__errorArgs, $__bag); ?>"
                                    ...
                                    <?php $__errorArgs = ['form_data.jenis_pemakaman'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <p class="form-error"><?php echo e($message); ?></p> <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                            data-required="true">
                                        <?php $__errorArgs = ['form_data.tanggal_wafat'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <p class="form-error"><?php echo e($message); ?></p> <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                        ...
                                        <?php $__errorArgs = ['form_data.tempat_pemakaman'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <p class="form-error"><?php echo e($message); ?></p> <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                            data-required="true">
                                        <?php $__errorArgs = ['form_data.tanggal_pemakaman'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <p class="form-error"><?php echo e($message); ?></p> <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                        ...
                                        <?php $__errorArgs = ['form_data.kronologi_ck'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <p class="form-error"><?php echo e($message); ?></p> <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                            data-required="true">
                                        <?php $__errorArgs = ['form_data.tanggal_kremasi'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <p class="form-error"><?php echo e($message); ?></p> <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                        ...
                                        <?php $__errorArgs = ['form_data.tempat_penyimpanan_abu'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
