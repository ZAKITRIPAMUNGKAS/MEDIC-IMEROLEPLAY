    ...
    <div class="relative min-h-screen py-8 px-4 sm:px-6 lg:px-8">
        ...
        <div class="relative max-w-7xl w-full mx-auto text-white">
                ...
                <form method="GET" action="<?php echo e(route('admin.attendance-reports.index')); ?>"
                    ...
                    <div>
                        ...
                        <select name="hospital"
                            ...
                            <option value="roxwood" <?php if(request('hospital') == 'roxwood'): echo 'selected'; endif; ?>
                    ...
                    <div class="flex items-center">
                        ...
                        <div>
                            ...
                            <p class="text-2xl font-bold text-white">
                                <?php echo e(\App\Helpers\TimeHelper::formatDuration($summary['total_hours'])); ?>
                ...
                <div class="backdrop-blur-xl border-2 border-sky-400/60 rounded-2xl shadow-2xl p-6"
                    ...
                    <div class="flex items-center">
                        ...
                        <div>
                            ...
                            <p class="text-2xl font-bold text-white">
                                <?php echo e(\App\Helpers\TimeHelper::formatDuration($summary['average_hours'])); ?>
            ...
            <div class="backdrop-blur-xl border-2 border-sky-400/60 rounded-2xl shadow-2xl mb-8"
                            ...
                            <div class="flex flex-col sm:flex-row sm:items-center justify-between mb-4">
                                <div>
                                    ...
                                    <p class="text-gray-300 text-sm">Detail absensi per hari untuk periode
                                        <?php echo e($filters['date_from']); ?> - <?php echo e($filters['date_to']); ?>
                            ...
                            <div class="overflow-x-auto">
                                <table class="min-w-full bg-white/5 rounded-lg overflow-hidden">
                                    <thead class="bg-black/30">
                                        <tr>
                                            <th
                                                class="px-2 py-3 text-left text-xs font-medium text-gray-300 uppercase tracking-wider">Tanggal</th>
                                                    <th class="px-2 py-3 text-left text-xs font-medium text-gray-300 uppercase tracking-wider">Staf</th>
                                                    <th class="px-2 py-3 text-center text-xs font-medium text-gray-300 uppercase tracking-wider">Waktu (In/Out)</th>
                                                    <th class="px-2 py-3 text-center text-xs font-medium text-gray-300 uppercase tracking-wider">Durasi & Jadwal</th>
                                                    <th class="px-2 py-3 text-center text-xs font-medium text-gray-300 uppercase tracking-wider">Status & Total</th>
                                                    <th class="px-2 py-3 text-left text-xs font-medium text-gray-300 uppercase tracking-wider">Catatan</th>
                                                    <th class="px-2 py-3 text-center text-xs font-medium text-gray-300 uppercase tracking-wider">Aksi</th>
                                                </tr>
                                            </thead>
                                            <tbody class="divide-y divide-white/10">
                                                <?php $__currentLoopData = $attendances; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $attendance): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <tr class="table-row-hover transition-all duration-200">
                                                        <td class="px-2 py-3">
                                                            <div class="text-white text-sm font-medium"><?php echo e($attendance->work_date->format('d/m/y')); ?></div>
                                                            <div class="text-gray-400 text-[10px] uppercase"><?php echo e($attendance->work_date->format('D')); ?></div>
                                                        </td>
                                                        <td class="px-2 py-3">
                                                            <div class="flex items-center">
                                                                <div class="hidden sm:flex w-8 h-8 bg-gradient-to-br from-blue-500 to-cyan-500 rounded flex items-center justify-center mr-2">
                                                                    <i class="fas fa-user text-white text-[10px]"></i>
                                                                </div>
                                                                <div class="max-w-[120px]">
                                                                    <p class="text-white text-xs font-semibold truncate" title="<?php echo e($attendance->user->name ?? 'User #' . $attendance->user_id); ?>">
                                                                        <?php echo e($attendance->user->name ?? 'User #' . $attendance->user_id); ?>

                                                                    </p>
                                                                    <div class="flex items-center gap-1 mt-0.5">
                                                                        <span class="inline-flex items-center px-1 py-0.5 rounded text-[9px] font-medium <?php echo e($attendance->session_type === 'meeting' ? 'bg-purple-500/20 text-purple-300 border border-purple-500/30' : 'bg-green-500/20 text-green-300 border border-green-500/30'); ?>">
                                                                            <?php echo e($attendance->session_type === 'meeting' ? 'MTG' : 'KERJA'); ?>
                                                        ...
                                                        <td class="px-2 py-3 text-center">
                                                            <div class="text-white text-xs font-medium">
                                                                <?php echo e($attendance->clock_in ? $attendance->clock_in->setTimezone('Asia/Jakarta')->format('H:i') : '--:--'); ?>

                                                                -
                                                                <?php echo e($attendance->clock_out ? $attendance->clock_out->setTimezone('Asia/Jakarta')->format('H:i') : '--:--'); ?>

                                                            </div>
                                                            <div class="text-gray-400 text-[10px]">WIB</div>
                                                        </td>
                                                        <td class="px-2 py-3 text-center">
                                                            <?php if($attendance->scheduled_duty_minutes): ?>
                                                                <div class="text-sky-300 text-[10px] whitespace-nowrap">Jadwal: <?php echo e($attendance->scheduled_duty_minutes); ?>m</div>
                                                            <?php endif; ?>
                                                            ...
                                                            <?php if($attendance->is_active): ?>
                                                                ...
                                                                <?php if($remainingTime !== null): ?>
                                                                    <div class="text-<?php echo e($remainingTime > 0 ? 'yellow' : 'red'); ?>-300 text-xs font-bold font-mono whitespace-nowrap"
                                                                        ...
                                                                        <?php echo e(\App\Helpers\TimeHelper::formatDuration(max(0, $remainingTime))); ?>

                                                                    </div>
                                                                <?php else: ?>
                                                                    <div class="text-white text-xs font-mono font-bold whitespace-nowrap" id="elapsed-time-<?php echo e($attendance->id); ?>"
                                                        ...
                                                        <td class="px-2 py-3 text-center">
                                                            ...
                                                            <?php if($attendance->clock_out): ?>
                                                                <span class="inline-flex items-center px-1.5 py-0.5 bg-green-500/20 text-green-300 rounded text-[9px] font-medium border border-green-500/30">
                                                                    DONE
                                                                </span>
                                                            <?php else: ?>
                                                                <span class="inline-flex items-center px-1.5 py-0.5 bg-yellow-500/20 text-yellow-300 rounded text-[9px] font-medium border border-yellow-500/30">
                                                                    ACTIVE
                                                                </span>
                                                            <?php endif; ?>
                                                        </td>
                                                        <td class="px-2 py-3">
                                                            <?php if($attendance->notes): ?>
                                                                <div class="text-white text-[10px] max-w-[120px] line-clamp-2" title="<?php echo e($attendance->notes); ?>">
                                                            ...
                                                            <div class="flex flex-col items-center justify-center gap-1">
                                                                <?php if(!$attendance->clock_out): ?>
                                                                    <button
                                                                        ...
                                                                        class="force-checkout-btn w-full inline-flex items-center justify-center px-1.5 py-1 bg-red-500/20 hover:bg-red-500/30 text-red-300 rounded border border-red-500/30 text-[10px]"
                                                                ...
                                                                <button
                                                                    ...
                                                                    class="w-full inline-flex items-center justify-center px-1.5 py-1 bg-sky-500/20 hover:bg-sky-500/30 text-sky-300 rounded border border-sky-500/30 text-[10px]">
                                                                    EDIT
                                                                </button>
                                                                <button
                                                                    onclick="deleteAttendance(<?php echo e($attendance->id); ?>, <?php echo e(json_encode($attendance->user->name ?? 'User #' . $attendance->user_id)); ?>)"
                                                                    class="w-full inline-flex items-center justify-center px-1.5 py-1 bg-red-500/20 hover:bg-red-500/30 text-red-300 rounded border border-red-500/30 text-[10px]">
                                                                    HAPUS
                                                                </button>
                                                            </div>
                                                        </td>
                                    ...
                                    <?php if($attendances->hasPages()): ?>
                                        <div class="mt-6 flex flex-col sm:flex-row items-center justify-between gap-4">
                                            ...
                                            <div class="flex items-center space-x-2">
                                                <?php if($attendances->onFirstPage()): ?>
                                                ...
                                                <?php if($attendances->hasMorePages()): ?>
                            ...
                            <?php if($weeklyData->count() > 0): ?>
                                <div class="overflow-x-auto">
                                    <table class="min-w-full bg-white/5 rounded-lg overflow-hidden">
                                        ...
                                        <tbody class="divide-y divide-white/10">
                                            <?php $__currentLoopData = $weeklyData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $weekStart => $weekAttendances): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <?php
                                                ...
                                                <tr class="table-row-hover transition-all duration-200">
                                                    ...
                                                    <td class="px-4 py-4">
                                                        ...
                                                        ?>
                                                        <div class="space-y-2">
                                                            <?php $__currentLoopData = $byUser; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $userId => $items): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <?php
                            ...
                            <?php if($monthlyData->count() > 0): ?>
                                <div class="overflow-x-auto">
                                    <table class="min-w-full bg-white/5 rounded-lg overflow-hidden">
                                        ...
                                        <tbody class="divide-y divide-white/10">
                                            <?php $__currentLoopData = $monthlyData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $month => $monthAttendances): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <?php
                ...
                <!-- User Statistics -->
                <?php if($summary['user_stats']->count() > 0): ?>
                    <div class="glass-effect rounded-2xl elegant-shadow-lg p-6 mb-8">
                        ...
                        <div class="overflow-x-auto">
                            <table class="min-w-full bg-white/5 rounded-lg overflow-hidden">
                                ...
                                <tbody class="divide-y divide-white/10">
                                    <?php $__currentLoopData = $summary['user_stats']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $userStat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
