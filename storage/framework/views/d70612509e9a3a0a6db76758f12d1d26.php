...
<?php $__env->startSection('title', 'Pengaturan Telegram Bot - Portal Medis MPK-BA'); ?>
...
<div class="relative min-h-screen py-8 px-4 sm:px-6 lg:px-8">
    ...
    <div class="relative max-w-4xl w-full mx-auto">
        ...
        <div class="bg-white rounded-2xl shadow-2xl overflow-hidden">
            <!-- Status Banner -->
            <div class="bg-gradient-to-r <?php echo e($settings->enabled ? 'from-green-500 to-emerald-500' : 'from-slate-400 to-slate-500'); ?> p-4">
                <div class="flex items-center justify-between text-white">
                    <div class="flex items-center gap-3">
                        <div class="w-10 h-10 bg-white/20 backdrop-blur-sm rounded-full flex items-center justify-center">
                            <i class="fas <?php echo e($settings->enabled ? 'fa-check-circle' : 'fa-times-circle'); ?> text-xl"></i>
                        </div>
                        <div>
                            <p class="text-xs font-medium opacity-90">Status Notifikasi</p>
                            <p class="text-lg font-bold"><?php echo e($settings->enabled ? 'Aktif' : 'Nonaktif'); ?></p>
                        </div>
                    </div>
                    <div class="text-right hidden sm:block">
                        <p class="text-xs opacity-90">Admin Terdaftar</p>
                        <p class="text-2xl font-bold"><?php echo e(count($settings->chat_ids_array)); ?></p>
                    </div>
                </div>
            </div>
            ...
            <!-- Settings Form -->
            <div class="p-6">
                <form action="<?php echo e(route('admin.telegram.update')); ?>" method="POST" class="space-y-6">
                    <?php echo csrf_field(); ?>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <input type="text" name="bot_token" id="botToken" 
                                value="<?php echo e(old('bot_token', $settings->bot_token)); ?>"
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($settings->bot_token): ?>
                    ...
                    <div>
                        <label class="flex items-center gap-2 text-sm font-bold text-slate-700 mb-3">
                            ...
                            <span class="ml-auto text-xs font-normal text-slate-500">
                                <?php echo e(count($settings->chat_ids_array) > 0 ? count($settings->chat_ids_array) . ' admin terdaftar' : 'Belum ada admin'); ?>

                            </span>
                        </label>
                        <div class="relative">
                            <input type="text" name="chat_ids" id="chatIds"
                                value="<?php echo e(old('chat_ids', $settings->chat_ids)); ?>"
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($settings->chat_ids): ?>
                        ...
                        <div class="mb-6">
                            <label class="flex items-center gap-4 p-4 bg-gradient-to-r from-slate-50 to-slate-100 rounded-xl cursor-pointer border-2 border-slate-200 hover:border-blue-300 transition-all">
                                ...
                                <input type="checkbox" name="enabled" id="enabled" value="1" 
                                    <?php echo e(old('enabled', $settings->enabled) ? 'checked' : ''); ?>
                            ...
                            <div class="space-y-3">
                                ...
                                <label class="flex items-center gap-3 p-4 bg-sky-50 rounded-xl cursor-pointer border-2 border-sky-200 hover:border-sky-400 transition-all group">
                                    ...
                                    <input type="checkbox" name="notify_chat" id="notify_chat" value="1"
                                        <?php echo e(old('notify_chat', $settings->notify_chat) ? 'checked' : ''); ?>
                                ...
                                <label class="flex items-center gap-3 p-4 bg-amber-50 rounded-xl cursor-pointer border-2 border-amber-200 hover:border-amber-400 transition-all group">
                                    ...
                                    <input type="checkbox" name="notify_feedback" id="notify_feedback" value="1"
                                        <?php echo e(old('notify_feedback', $settings->notify_feedback) ? 'checked' : ''); ?>
                ...
                <!-- Test Button -->
                <form action="<?php echo e(route('admin.telegram.test')); ?>" method="POST" class="mt-3">
                    <?php echo csrf_field(); ?>
                    <button type="submit"
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\website\EMS-IME\public_html\resources\views\admin\telegram\index.blade.php ENDPATH**/ ?>