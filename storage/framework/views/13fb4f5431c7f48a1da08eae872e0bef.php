            ...
            <form method="GET" action="<?php echo e(route('staff.forms')); ?>" class="grid grid-cols-1 md:grid-cols-5 gap-4">
                ...
                <div>
                    <select name="type" class="w-full bg-white/30 backdrop-blur-xl text-white border-2 border-sky-400/40 rounded-xl px-4 py-3 focus:ring-2 focus:ring-sky-500 focus:border-sky-500 text-sm font-medium shadow-xl transition-all duration-200">
                        ...
                        <option value="penyakit_dalam" class="bg-slate-800 text-slate-300" <?php echo e(request('type') == 'penyakit_dalam' ? 'selected' : ''); ?>>Poli Penyakit Dalam</option>
                        <option value="spesialis_anak" class="bg-slate-800 text-slate-300" <?php echo e(request('type') == 'spesialis_anak' ? 'selected' : ''); ?>>Poli Spesialis Anak</option>
                        <option value="spesialis_bedah" class="bg-slate-800 text-slate-300" <?php echo e(request('type') == 'spesialis_bedah' ? 'selected' : ''); ?>>Poli Spesialis Bedah</option>
                        <option value="spesialis_mata" class="bg-slate-800 text-slate-300" <?php echo e(request('type') == 'spesialis_mata' ? 'selected' : ''); ?>>Poli Spesialis Mata</option>
                        <option value="spesialis_saraf" class="bg-slate-800 text-slate-300" <?php echo e(request('type') == 'spesialis_saraf' ? 'selected' : ''); ?>>Poli Spesialis Saraf</option>
                        <option value="spesialis_urologi" class="bg-slate-800 text-slate-300" <?php echo e(request('type') == 'spesialis_urologi' ? 'selected' : ''); ?>>Poli Spesialis Urologi</option>
                        <option value="spesialis_tht" class="bg-slate-800 text-slate-300" <?php echo e(request('type') == 'spesialis_tht' ? 'selected' : ''); ?>>Poli Spesialis THT</option>
                        <option value="spesialis_ortopedi" class="bg-slate-800 text-slate-300" <?php echo e(request('type') == 'spesialis_ortopedi' ? 'selected' : ''); ?>>Poli Spesialis Ortopedi</option>
