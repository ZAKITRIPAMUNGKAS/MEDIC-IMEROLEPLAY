<?php $__env->startSection('title', 'Meeting Requests — Admin - Portal Medis'); ?>
    ...
    <div class="relative min-h-screen py-8 px-4 sm:px-6 lg:px-8 font-sans">
        ...
        <div class="max-w-6xl mx-auto relative z-10">
            ...
            <div class="mb-10 flex flex-col md:flex-row md:items-end justify-between gap-6">
                ...
                <form method="GET" class="flex items-center gap-3 w-full md:w-auto">
                    ...
                    <div class="relative w-full md:w-80">
                        ...
                        <input type="text" name="q" value="<?php echo e(request('q')); ?>" placeholder="Cari nama staf..."
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(request('q')): ?>
                        <a href="?status=<?php echo e($status); ?>" title="Hapus Pencarian"
            ...
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-5 mb-10">
                <!-- Pending Tab -->
                <a href="?status=pending" class="group glass-effect rounded-2xl p-6 border shadow-sm transition-all duration-300 hover:shadow-xl hover:-translate-y-1 relative overflow-hidden <?php echo e($status === 'pending' ? 'border-sky-400 ring-1 ring-sky-400/50' : 'border-white/10 hover:border-white/30 bg-white/5'); ?>">
                    <div class="flex items-start justify-between relative z-10">
                        <div>
                            <p class="text-xs font-bold text-gray-300 uppercase tracking-widest mb-1">Menunggu</p>
                            <p class="text-4xl font-black text-white"><?php echo e($pendingCount); ?></p>
                        </div>
                ...
                <!-- Approved Tab -->
                <a href="?status=approved" class="group glass-effect rounded-2xl p-6 border shadow-sm transition-all duration-300 hover:shadow-xl hover:-translate-y-1 relative overflow-hidden <?php echo e($status === 'approved' ? 'border-sky-400 ring-1 ring-sky-400/50' : 'border-white/10 hover:border-white/30 bg-white/5'); ?>">
                    <div class="flex items-start justify-between relative z-10">
                        <div>
                            <p class="text-xs font-bold text-gray-300 uppercase tracking-widest mb-1">Disetujui</p>
                            <p class="text-4xl font-black text-white"><?php echo e($approvedCount); ?></p>
                        </div>
                ...
                <!-- Rejected Tab -->
                <a href="?status=rejected" class="group glass-effect rounded-2xl p-6 border shadow-sm transition-all duration-300 hover:shadow-xl hover:-translate-y-1 relative overflow-hidden <?php echo e($status === 'rejected' ? 'border-sky-400 ring-1 ring-sky-400/50' : 'border-white/10 hover:border-white/30 bg-white/5'); ?>">
                    <div class="flex items-start justify-between relative z-10">
                        <div>
                            <p class="text-xs font-bold text-gray-300 uppercase tracking-widest mb-1">Ditolak</p>
                            <p class="text-4xl font-black text-white"><?php echo e($rejectedCount); ?></p>
                        </div>
            ...
            <div class="space-y-5">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($requests->isEmpty()): ?>
                    <div class="glass-effect border border-white/20 rounded-3xl p-16 text-center shadow-lg">
                        ...
                        <p class="text-sky-200/80 mt-2 max-w-sm mx-auto">Belum ada pengajuan meeting <?php echo e($status === 'pending' ? 'yang menunggu persetujuan' : ''); ?> saat ini. Semuanya sudah tertangani!</p>
                    </div>
                <?php else: ?>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $requests; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $req): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="bg-white/5 backdrop-blur-md rounded-3xl border border-white/10 shadow-lg hover:border-white/30 transition-all duration-300 p-6 sm:p-8" id="request-<?php echo e($req->id); ?>">
                            <div class="flex flex-col lg:flex-row justify-between gap-8">
                                ...
                                <div class="flex-1">
                                    ...
                                    <div class="flex items-center gap-4 mb-6">
                                        <div class="w-14 h-14 rounded-full bg-gradient-to-br from-sky-400 to-blue-600 text-white font-bold flex items-center justify-center text-xl shadow-md border border-white/20">
                                            <?php echo e(strtoupper(substr($req->user->name, 0, 1))); ?>

                                        </div>
                                        <div>
                                            <h3 class="text-xl font-bold text-white leading-tight"><?php echo e($req->user->name); ?></h3>
                                            <div class="flex flex-wrap items-center gap-2 mt-1.5">
                                                <span class="text-xs font-semibold bg-white/10 text-gray-300 border border-white/10 px-2.5 py-1 rounded-md">
                                                    <?php echo e($req->user->hospital === 'roxwood' ? '🏥 Roxwood Hospital' : '🏥 Alta Hospital'); ?>
                                        ...
                                        <div class="ml-auto flex items-start self-start">
                                            <span class="<?php echo e($statusStyle); ?> border px-3 py-1.5 rounded-lg text-xs font-bold inline-flex items-center shadow-sm">
                                    ...
                                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6">
                                        <div class="flex items-center gap-3 bg-white/5 p-3.5 rounded-2xl border border-white/10">
                                            ...
                                            <div>
                                                ...
                                                <p class="font-semibold text-white mt-0.5"><?php echo e($req->requested_date->format('d M Y')); ?></p>
                                            </div>
                                        </div>
                                        <div class="flex items-center gap-3 bg-white/5 p-3.5 rounded-2xl border border-white/10">
                                            <div class="w-10 h-10 rounded-xl bg-sky-500/20 border border-sky-500/30 flex items-center justify-center text-sky-400">
                                            ...
                                            <div>
                                                ...
                                                <p class="font-semibold text-white mt-0.5">
                                                    ...
                                                    <span class="text-sky-300 font-normal ml-1">(<?php echo e($req->getFormattedDuration()); ?>)</span>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="bg-blue-500/10 rounded-2xl p-5 border border-blue-500/20">
                                        ...
                                        <p class="text-gray-200 text-sm leading-relaxed"><?php echo e($req->reason); ?></p>
                                    </div>
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($req->review_notes): ?>
                                        <div class="mt-4 text-sm flex items-start gap-3 p-4 bg-rose-500/10 rounded-2xl border border-rose-500/20">
                                            ...
                                            <div>
                                                <span class="font-bold text-rose-200 block mb-0.5">Catatan Admin (<?php echo e($req->reviewer->name ?? 'Sistem'); ?>)</span>
                                                <p class="text-rose-100/80"><?php echo e($req->review_notes); ?></p>
                                            </div>
                                        </div>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                </div>
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($req->isPending()): ?>
                                    <div class="flex flex-col justify-center gap-3 lg:w-48 lg:border-l border-white/10 lg:pl-8 pt-6 lg:pt-0 border-t lg:border-t-0 mt-6 lg:mt-0">
                                        <button onclick="approveRequest(<?php echo e($req->id); ?>)"
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\website\EMS-IME\public_html\resources\views/admin/meeting-requests/index.blade.php ENDPATH**/ ?>