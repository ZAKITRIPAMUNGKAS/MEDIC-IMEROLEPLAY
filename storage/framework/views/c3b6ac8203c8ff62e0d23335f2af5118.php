...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            ...
                            <div>
                                ...
                                <input type="text" name="citizen_id" value="<?php echo e(old('citizen_id', $user->citizen_id)); ?>"
                                    placeholder="Contoh: JDN12345"
                                    class="w-full bg-white/10 text-white placeholder-gray-400 border border-white/20 rounded-lg px-4 py-3 focus:ring-2 focus:ring-sky-400 focus:border-sky-400 transition-all duration-300">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['citizen_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                            ...
                            <div class="bg-white/5 rounded-lg p-4 border border-white/10">
                                <label class="flex items-center cursor-pointer">
                                    <input type="checkbox" name="custom_permissions[]" value="view_attendance_reports"
                                        ...
                                        <?php if(in_array('view_attendance_reports', old('custom_permissions', $user->custom_permissions ?? []))): echo 'checked'; endif; ?>>
                                    <div class="ml-3">
                                        <span class="text-white font-medium flex items-center">
                                ...
                                <div class="bg-white/5 rounded-lg p-4 border border-white/10">
                                    <label class="flex items-center cursor-pointer">
                                        <input type="checkbox" name="custom_permissions[]" value="manage_users"
                                            ...
                                            <?php if(in_array('manage_users', old('custom_permissions', $user->custom_permissions ?? []))): echo 'checked'; endif; ?>>
                                        <div class="ml-3">
                                            <span class="text-white font-medium flex items-center">
