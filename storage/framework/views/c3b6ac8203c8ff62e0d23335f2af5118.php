...
<div class="relative min-h-screen py-8 px-4 sm:px-6 lg:px-8">
    ...
    <div class="relative max-w-4xl w-full mx-auto text-white">
            ...
            <div class="bg-white/5 rounded-xl p-4 border border-white/10">
                <div class="flex items-center">
                    ...
                    <div>
                        ...
                        <p class="text-gray-400 text-xs">Terakhir diperbarui: <?php echo e(optional($user->updated_at)->format('d M Y, H:i') ?? '-'); ?></p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="glass-effect rounded-2xl elegant-shadow-lg p-6 md:p-8">
            <form method="POST" action="<?php echo e(route('admin.staff.update', $user)); ?>" enctype="multipart/form-data" class="space-y-8">
                <?php echo csrf_field(); ?>
                ...
                <div class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="text" name="name" value="<?php echo e(old('name', $user->name)); ?>" placeholder="Masukkan nama lengkap" class="w-full bg-white/10 text-white placeholder-gray-400 border border-white/20 rounded-lg px-4 py-3 focus:ring-2 focus:ring-sky-400 focus:border-sky-400 transition-all duration-300" required>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        ...
                        <div>
                            ...
                            <input type="email" name="email" value="<?php echo e(old('email', $user->email)); ?>" placeholder="contoh@email.com" class="w-full bg-white/10 text-white placeholder-gray-400 border border-white/20 rounded-lg px-4 py-3 focus:ring-2 focus:ring-sky-400 focus:border-sky-400 transition-all duration-300" required>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <div class="flex items-center space-x-4">
                                <img src="<?php echo e($user->profile_image_url); ?>" alt="<?php echo e($user->name); ?>" onerror="this.onerror=null;this.src='<?php echo e(asset('profile.jpg')); ?>';" class="w-20 h-20 rounded-full border-4 border-sky-400 object-cover">
                                <div>
                                    <p class="text-white text-sm font-medium"><?php echo e($user->name); ?></p>
                                    <p class="text-gray-300 text-xs"><?php echo e($user->role->display_name ?? $user->role->name ?? 'Staff'); ?></p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <select name="role_id" class="w-full bg-white/10 text-white border border-white/20 rounded-lg px-4 py-3 focus:ring-2 focus:ring-sky-400 focus:border-sky-400 transition-all duration-300 appearance-none" required>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($role->id); ?>" <?php if(old('role_id', $user->role_id) == $role->id): echo 'selected'; endif; ?> class="bg-slate-800 text-slate-100">
                        ...
                        <div>
                            ...
                            <div class="flex items-center space-x-6">
                                <label class="flex items-center cursor-pointer">
                                    <input id="is_active" type="checkbox" name="is_active" value="1" class="sr-only" <?php if(old('is_active', $user->is_active)): echo 'checked'; endif; ?>>
                                    <div class="relative">
                                        <div class="w-12 h-6 <?php echo e(old('is_active', $user->is_active) ? 'bg-green-500' : 'bg-gray-500'); ?> rounded-full shadow-inner"></div>
                                        <div class="absolute top-1 <?php echo e(old('is_active', $user->is_active) ? 'left-7' : 'left-1'); ?> w-4 h-4 bg-white rounded-full shadow transform transition-transform duration-200 ease-in-out"></div>
                                    </div>
