    ...
    <div class="relative max-w-6xl w-full mx-auto">
        ...
        <div class="glass-effect rounded-2xl elegant-shadow-lg p-6 md:p-8 mb-6">
            <div class="flex flex-col sm:flex-row sm:items-center justify-between mb-6">
                ...
                <div class="flex flex-col sm:flex-row gap-3">
                    <a href="<?php echo e(route('staff.forms')); ?>" class="inline-flex items-center px-4 py-2 bg-white/10 text-white rounded-lg hover:bg-white/20 transition-all duration-300 text-sm font-medium backdrop-blur-sm border border-white/20">
                        <i class="fas fa-arrow-left mr-2"></i>Kembali ke Daftar
                    </a>
                    <?php if($form->status === 'pending'): ?>
                        <div class="flex gap-2">
                            <form method="POST" action="<?php echo e(route('staff.forms.reject', $form->id)); ?>" onsubmit="return confirm('Yakin ingin menolak formulir ini?');">
                                <?php echo csrf_field(); ?>
                            ...
                            <?php if($user->canApproveForm($form->form_type)): ?>
                                <?php
                                ...
                                ?>
                                <form method="POST" action="<?php echo e(route('staff.forms.approve', $form->id)); ?>" onsubmit="return confirm('<?php echo e($isAppointment ? 'Yakin ingin menandai janji temu sudah ditemui?' : 'Yakin ingin menyetujui formulir ini?'); ?>');">
                                    <?php echo csrf_field(); ?>
                            ...
                            <?php else: ?>
                                <button disabled class="inline-flex items-center px-4 py-2 bg-gray-500/50 text-gray-300 rounded-lg transition-all duration-300 text-sm font-medium shadow-lg cursor-not-allowed opacity-60" title="Level role Anda tidak mencukupi untuk menyetujui formulir ini">
                                    <i class="fas fa-lock mr-2"></i><?php echo e(in_array($form->form_type, ['penyakit_dalam', 'spesialis_anak', 'spesialis_bedah', 'spesialis_mata', 'spesialis_saraf', 'spesialis_urologi', 'spesialis_tht', 'spesialis_ortopedi']) ? 'Sudah Ditemui' : 'Setujui'); ?>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="lg:col-span-2">
                        ...
                        <div class="mb-8">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                                ...
                                <div class="group relative bg-gradient-to-br from-purple-500/10 via-purple-600/5 to-transparent rounded-xl p-5 border border-purple-500/20 hover:border-purple-400/40 transition-all duration-300 hover:shadow-lg hover:shadow-purple-500/10">
                                    ...
                                    <p class="text-white text-lg font-bold pr-10"><?php echo e($form->created_at->format('d F Y, H:i')); ?></p>
                                </div>
                                ...
                                <div class="group relative bg-gradient-to-br from-gray-500/10 via-gray-600/5 to-transparent rounded-xl p-5 border border-gray-500/20 hover:border-gray-400/40 transition-all duration-300 hover:shadow-lg hover:shadow-gray-500/10">
                                    ...
                                    <p class="text-white text-lg font-mono font-bold bg-black/40 px-3 py-1.5 rounded-lg border border-white/10 inline-block mt-1"><?php echo e($form->id); ?></p>
                                </div>
                            </div>
                        </div>

                        <!-- Data Formulir Lengkap -->
                        <?php if($form->form_data && is_array($form->form_data) && count($form->form_data) > 0): ?>
                                ...
                                <div class="overflow-x-auto">
                                    <table class="min-w-full">
                                        ...
                                        <tbody class="divide-y divide-white/5">
                                            <?php $__currentLoopData = $form->form_data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <?php if($value !== null && $value !== '' && !in_array($key, ['photo_ktp_url', 'photo_skb_url'])): ?>
                                                    <?php
                                                    ...
                                                    <tr class="hover:bg-white/10 transition-all duration-200 group">
                                                        <td class="px-6 py-4">
                                                            <div class="flex items-center space-x-3">
                                                                ...
                                                                <span class="text-gray-300 font-medium text-sm"><?php echo e($displayLabel); ?></span>
                                                            </div>
                                                        </td>
                                                        <td class="px-6 py-4">
                ...
                <?php if($form->form_type === 'tes_psikologi'): ?>
                <?php
                ...
                <div class="backdrop-blur-xl border-2 border-sky-400/60 rounded-2xl shadow-2xl p-6 md:p-8 mb-6" style="background-color: rgba(7, 89, 133, 0.9);">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <div class="bg-white/5 rounded-xl p-4 border border-white/10">
                            ...
                            <p class="text-white text-2xl font-extrabold"><?php echo e($stressTotal); ?></p>
                        </div>
                        <div class="bg-white/5 rounded-xl p-4 border border-white/10">
                            <label class="text-gray-300 text-sm font-medium block mb-2">Level Stres</label>
                            <span class="inline-flex items-center px-3 py-1 rounded-full text-sm font-bold <?php echo e($badgeClasses); ?>"><?php echo e($stressLevel); ?></span>
                        </div>
                        <div class="bg-white/5 rounded-xl p-4 border border-white/10">
                            <label class="text-gray-300 text-sm font-medium block mb-2">Interpretasi</label>
                            <p class="text-sky-200">
                                <?php if($stressLevel === 'Rendah'): ?>
                                    Indikasi stres rendah.
                                <?php elseif($stressLevel === 'Sedang'): ?>
                ...
                <?php if($form->form_type === 'operasi_plastik'): ?>
                <div class="backdrop-blur-xl border-2 border-sky-400/60 rounded-2xl shadow-2xl p-6 md:p-8 mb-6" style="background-color: rgba(7, 89, 133, 0.9);">
                    <h2 class="text-2xl font-bold text-white mb-6 flex items-center">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="bg-white/5 rounded-xl p-4 border border-white/10">
                            ...
                            <div class="relative">
                                <?php if(isset($form->form_data['photo_ktp_url']) && !empty($form->form_data['photo_ktp_url'])): ?>
                                    <div class="relative">
                                        <img src="<?php echo e($form->form_data['photo_ktp_url']); ?>" 
                                             alt="Foto KTP" 
                                        ...
                                        <div class="hidden text-center py-8 bg-white/5 rounded-lg border border-white/10">
                                            ...
                                            <p class="text-gray-400 text-sm mt-2">URL: <?php echo e($form->form_data['photo_ktp_url']); ?></p>
                                        </div>
                                    </div>
                                <?php else: ?>
                        ...
                        <div class="bg-white/5 rounded-xl p-4 border border-white/10">
                            ...
                            <div class="relative">
                                <?php if(isset($form->form_data['photo_skb_url']) && !empty($form->form_data['photo_skb_url'])): ?>
                                    <div class="relative">
                                        <img src="<?php echo e($form->form_data['photo_skb_url']); ?>" 
                                             alt="Foto SKB" 
                                             class="w-full h-auto rounded-lg border border-white/20 shadow-lg hover:scale-105 transition-transform duration-300 cursor-pointer"
                                        ...
                                        <div class="hidden text-center py-8 bg-white/5 rounded-lg border border-white/10">
                                            ...
                                            <p class="text-gray-400 text-sm mt-2">URL: <?php echo e($form->form_data['photo_skb_url']); ?></p>
                                        </div>
                                    </div>
                                <?php else: ?>
                                    <div class="text-center py-8 bg-white/5 rounded-lg border border-white/10">
                    ...
                    <div class="bg-gradient-to-br from-amber-500/20 to-orange-500/20 rounded-xl p-6 border border-amber-500/30">
                        <div class="mb-4">
                            <div class="flex items-center justify-between mb-3">
                                ...
                                <div class="flex text-yellow-400">
                                    <?php for($i = 1; $i <= 5; $i++): ?>
                                        <i class="fas fa-star <?php echo e($i <= $form->rating ? 'text-yellow-400' : 'text-gray-500'); ?>"></i>
                                    <?php endfor; ?>
                        ...
                        <div class="mt-4 pt-4 border-t border-white/10">
                            <div class="flex items-center justify-between">
                                ...
                                <?php if($form->testimoni_approved): ?>
                            ...
                            <?php if(!$form->testimoni_approved): ?>
                            <form method="POST" action="<?php echo e(route('staff.forms.testimoni.approve', $form->id)); ?>" class="mt-4" onsubmit="return confirm('Yakin ingin menyetujui testimoni ini untuk ditampilkan di halaman beranda?');">
                                <?php echo csrf_field(); ?>
                    ...
                    <div class="space-y-3">
                        <?php if($form->status === 'pending'): ?>
                            ...
                            <?php if($canApprove): ?>
                                <form method="POST" action="<?php echo e(route('staff.forms.approve', $form->id)); ?>" onsubmit="return confirm('<?php echo e($isAppointment ? 'Yakin ingin menandai janji temu sudah ditemui?' : 'Yakin ingin menyetujui formulir ini?'); ?>');">
                                    <?php echo csrf_field(); ?>
                                    <button class="w-full flex items-center justify-center px-4 py-3 <?php echo e($isAppointment ? 'bg-green-500 hover:bg-green-600' : 'bg-sky-500 hover:bg-sky-600'); ?> text-white rounded-lg transition-all duration-300 font-medium shadow-lg">
                                        <i class="fas fa-check mr-2"></i><?php echo e($isAppointment ? 'Sudah Ditemui' : 'Setujui Formulir'); ?>
                        ...
                        <a href="<?php echo e(route('staff.forms')); ?>" class="w-full flex items-center justify-center px-4 py-3 bg-white/10 hover:bg-white/20 text-white rounded-lg transition-all duration-300 font-medium border border-white/20">
                ...
                <div class="backdrop-blur-xl border-2 border-sky-400/60 rounded-2xl shadow-2xl p-6" style="background-color: rgba(7, 89, 133, 0.9);">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="flex justify-between items-center py-2">
                            ...
                            <span class="text-white text-sm font-medium"><?php echo e($form->created_at->diffInHours($form->updated_at)); ?> jam</span>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="space-y-4">
                        <div class="flex items-center">
                            ...
                            <div>
                                ...
                                <p class="text-gray-400 text-xs"><?php echo e($form->created_at->setTimezone('Asia/Jakarta')->format('d M Y, H:i')); ?> WIB</p>
                            </div>
                        </div>
                        
                        <?php if($form->status !== 'pending'): ?>
                            <div class="flex items-center">
                                <div class="w-3 h-3 bg-<?php echo e($form->status === 'approved' ? 'green' : 'red'); ?>-500 rounded-full mr-3"></div>
                                <div>
                                    <p class="text-white text-sm font-medium">
                                        <?php echo e($form->status === 'approved' ? 'Disetujui' : 'Ditolak'); ?>

                                    </p>
                                    <p class="text-gray-400 text-xs"><?php echo e($form->updated_at->setTimezone('Asia/Jakarta')->format('d M Y, H:i')); ?> WIB</p>
                                </div>
                            </div>
                        <?php else: ?>
                            <div class="flex items-center">
