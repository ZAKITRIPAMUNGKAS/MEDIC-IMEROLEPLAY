                                                    ...
                                                    <?php $__currentLoopData = $form->form_data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <?php if($value !== null && $value !== '' && !in_array($key, ['photo_ktp_url', 'photo_skb_url'])): ?>
                                                            ...
                                                            <tr class="hover:bg-white/10 transition-all duration-200 group">
                                                                ...
                                                                <td class="px-6 py-4">
                                                                    <span
                                                                        class="text-white font-semibold"><?php echo e($displayValue ?: '-'); ?></span>
                                                                </td>
                                                            </tr>
                                                        <?php endif; ?>
                            ...
                            <div class="backdrop-blur-xl border-2 border-sky-400/60 rounded-2xl shadow-2xl p-6 md:p-8 mb-6"
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                                    ...
                                    <div class="bg-white/5 rounded-xl p-4 border border-white/10">
                                        ...
                                        <span
                                            class="inline-flex items-center px-3 py-1 rounded-full text-sm font-bold <?php echo e($badgeClasses); ?>"><?php echo e($stressLevel); ?></span>
                                    </div>
                                    <div class="bg-white/5 rounded-xl p-4 border border-white/10">
