        ...
        <div class="bg-white rounded-2xl shadow-xl border border-slate-200 p-6">
            <form action="<?php echo e(route('admin.telegram.update')); ?>" method="POST" class="space-y-6">
                ...
                <div>
                    ...
                    <input type="text" name="bot_token" value="<?php echo e(old('bot_token', $settings->bot_token)); ?>"
                ...
                <div>
                    ...
                    <input type="text" name="chat_ids" value="<?php echo e(old('chat_ids', $settings->chat_ids)); ?>"
                        class="w-full px-4 py-3 rounded-lg border border-slate-300 focus:border-blue-500 focus:ring-2 focus:ring-blue-200 outline-none transition-all font-mono text-sm"
            ...
            <!-- Test Button -->
            <form action="<?php echo e(route('admin.telegram.test')); ?>" method="POST" class="mt-4">
                <?php echo csrf_field(); ?>
                <button type="submit"
        ...
        <div class="mt-6 bg-slate-50 rounded-xl p-4 border border-slate-200">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-3 text-sm">
                <div class="flex items-center gap-2">
                    <div class="w-3 h-3 rounded-full <?php echo e($settings->enabled ? 'bg-green-500' : 'bg-red-500'); ?>"></div>
                    <span class="text-slate-600">
                        Status: <strong class="<?php echo e($settings->enabled ? 'text-green-600' : 'text-red-600'); ?>">
                            <?php echo e($settings->enabled ? 'Aktif' : 'Nonaktif'); ?>
                ...
                <div class="flex items-center gap-2">
                    ...
                    <span class="text-slate-600">
                        Bot: <strong><?php echo e($settings->bot_token ? 'Terkonfigurasi' : 'Belum diisi'); ?></strong>
                    </span>
                </div>
                <div class="flex items-center gap-2">
                    <i class="fas fa-users text-green-500"></i>
                    <span class="text-slate-600">
                        Admin: <strong><?php echo e(count($settings->chat_ids_array)); ?> orang</strong>
                    </span>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\website\EMS-IME\public_html\resources\views/admin/telegram/index.blade.php ENDPATH**/ ?>