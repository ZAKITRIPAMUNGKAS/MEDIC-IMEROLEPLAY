...
<?php $__env->startSection('title', 'Management Struktural EMS - Admin'); ?>
...
<?php $__env->startSection('content'); ?>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            ...
            <div class="max-w-md mx-auto mb-8">
                ...
                <select id="hospital-selector"
                    ...
                    <option value="ems" <?php echo e(request('hospital', 'ems') == 'ems' ? 'selected' : ''); ?>>EMS (Emergency Medical
                        Services)</option>
                    <option value="roxwood" <?php echo e(request('hospital') == 'roxwood' ? 'selected' : ''); ?>>Roxwood Hospital</option>
                </select>
            </div>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($activeStructure): ?>
                <form action="<?php echo e(route('admin.organizational-structure.update-names', $activeStructure->id)); ?>" method="POST"
                    id="edit-structure-form">
                    <?php echo csrf_field(); ?>
                    <?php echo method_field('PUT'); ?>
                    <input type="hidden" name="name" value="<?php echo e($activeStructure->name); ?>">
                    ...
                    <section class="relative">
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($structureData['high_command'])): ?>
                            <article class="relative mb-16">
                                ...
                                <div class="max-w-md mx-auto glass-effect rounded-2xl p-6">
                                    <select name="names[<?php echo e($nameIndex); ?>][name]"
                                        ...
                                        <option value="N/A" <?php echo e(($structureData['high_command']['name'] ?? '') == 'N/A' ? 'selected' : ''); ?>>N/A (Kosong)</option>
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($user->name); ?>" <?php echo e(($structureData['high_command']['name'] ?? '') == $user->name ? 'selected' : ''); ?>>
                                                <?php echo e($user->name); ?>

                                            </option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    </select>
                                    <input type="hidden" name="names[<?php echo e($nameIndex); ?>][position]" value="high_command">
                                    <?php $nameIndex++; ?>
                                </div>
                            </article>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($structureData['departments']) && is_array($structureData['departments'])): ?>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $structureData['departments']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $deptIndex => $dept): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <article class="relative mb-16">
                                    ...
                                    <div class="text-center mb-8">
                                        <div
                                            ...
                                            <h2 class="text-2xl font-black"><?php echo e($dept['title'] ?? 'Department'); ?></h2>
                                        </div>
                                    </div>
                                ...
                                <div class="max-w-md mx-auto mb-8 glass-effect rounded-2xl p-6">
                                    ...
                                    <select name="names[<?php echo e($nameIndex); ?>][name]" 
                                        ...
                                        <option value="">-- Pilih Kepala <?php echo e($dept['title'] ?? 'Department'); ?> --</option>
                                        <option value="N/A" <?php echo e(($dept['name'] ?? '') == 'N/A' ? 'selected' : ''); ?>>N/A (Kosong)</option>
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($user->name); ?>" <?php echo e(($dept['name'] ?? '') == $user->name ? 'selected' : ''); ?>>
                                                <?php echo e($user->name); ?>

                                            </option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    </select>
                                    <input type="hidden" name="names[<?php echo e($nameIndex); ?>][position]" value="department_<?php echo e($deptIndex); ?>">
                                    <?php $nameIndex++; ?>
                                </div>

                                    
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($dept['members']) && is_array($dept['members'])): ?>
                                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $dept['members']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $memberIndex => $member): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <div class="glass-effect rounded-xl p-4">
                                                    <label
                                                        class="block text-green-200 text-xs font-bold mb-2 text-center"><?php echo e($member['role'] ?? 'Staff'); ?></label>
                                                    <select name="names[<?php echo e($nameIndex); ?>][name]" 
                                                        ...
                                                        <option value="N/A" <?php echo e(($member['name'] ?? '') == 'N/A' ? 'selected' : ''); ?>>N/A</option>
                                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <option value="<?php echo e($user->name); ?>" <?php echo e(($member['name'] ?? '') == $user->name ? 'selected' : ''); ?>>
                                                                <?php echo e($user->name); ?>

                                                            </option>
                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                                    </select>
                                                    <input type="hidden" name="names[<?php echo e($nameIndex); ?>][position]"
                                                        value="department_<?php echo e($deptIndex); ?>_member_<?php echo e($memberIndex); ?>">
                                                    <?php $nameIndex++; ?>
                                                </div>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                        </div>
                    ...
                    <div class="max-w-2xl mx-auto mt-12 flex gap-4">
                        ...
                        <a href="<?php echo e(route('public.struktural-ems')); ?>" target="_blank"
            ...
            <?php else: ?>
                <div class="max-w-2xl mx-auto glass-effect rounded-2xl p-12 text-center">
                    ...
                    <p class="text-blue-200 mb-6">Belum ada struktur yang aktif untuk hospital
                        <?php echo e(strtoupper($selectedHospital)); ?>.</p>
                    <a href="<?php echo e(route('admin.organizational-structure.create')); ?>"
    ...
    <script>
        document.getElementById('hospital-selector').addEventListener('change', function () {
            window.location.href = '<?php echo e(route("admin.organizational-structure.index")); ?>?hospital=' + this.value;
        });
    </script>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\website\EMS-IME\public_html\resources\views/admin/organizational-structure/index.blade.php ENDPATH**/ ?>