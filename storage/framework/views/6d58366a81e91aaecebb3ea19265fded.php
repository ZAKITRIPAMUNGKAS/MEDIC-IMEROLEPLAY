                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->guard()->check()): ?>
                        ...
                        <div class="flex items-center space-x-2">
                            ...
                            <div class="flex items-center space-x-2">
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->user()->hasPermission('manage_users') || auth()->user()->hasPermission('view_reports') || auth()->user()->hasPermission('view_attendance_reports') || auth()->user()->hasPermission('access_live_chat') || auth()->user()->hasPermission('access_feedback') || auth()->user()->hasPermission('manage_meeting_requests')): ?>
                                    <div class="relative group">
                                        ...
                                        <div
                                            ...
                                            <div class="py-2">
                                                ...
                                                <?php if(auth()->user()->hasPermission('manage_meeting_requests')): ?>
                                                    <a href="<?php echo e(route('admin.meeting-requests.index')); ?>"
                                                        ...
                                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($pendingMeetingCount > 0): ?>
                                                            <span
                                                                class="ml-auto bg-yellow-500 text-white text-xs px-2 py-0.5 rounded-full"><?php echo e($pendingMeetingCount); ?></span>
                                                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                                    </a>
                                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    ...
                                    <div
                                        ...
                                        <div class="py-2">
                                            <?php if(auth()->user()->hasPermission('manage_payroll')): ?>
                                                ...
                                                <?php if(auth()->user()->hasPermission('manage_reimbursements')): ?>
                                                    <div class="border-t border-gray-200 my-1"></div>
