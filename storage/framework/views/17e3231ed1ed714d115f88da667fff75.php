<?php $__env->startSection('title', 'Janji Temu Berhasil Dikirim - Portal Medis MOTIONLIFE'); ?>
        ...
        <div class="card bg-white/98 backdrop-blur-lg shadow-2xl border border-white/30 rounded-3xl p-12 text-center animate-fade-in-up overflow-hidden">
            ...
            <div class="mb-8">
                ...
                <p class="text-2xl text-slate-700 mb-4 font-medium">
                    Terima kasih, <span class="font-bold text-sky-600 bg-sky-50 px-3 py-1 rounded-full"><?php echo e($appointment->character_name ?? 'N/A'); ?></span>
                </p>
                    ...
                    <div class="space-y-4">
                        <div class="group p-5 bg-white/90 rounded-2xl border border-sky-100 hover:border-sky-200 transition-all duration-300 hover:shadow-md">
                            <div class="flex items-center justify-between">
                                ...
                                <span class="font-mono text-lg font-bold text-sky-600 bg-sky-100 px-3 py-1 rounded-full">
                                    #<?php echo e(str_pad($appointment->id, 6, '0', STR_PAD_LEFT)); ?>
                        ...
                        <div class="group p-5 bg-white/90 rounded-2xl border border-sky-100 hover:border-sky-200 transition-all duration-300 hover:shadow-md">
                            <div class="flex items-center justify-between">
                                ...
                                <span class="font-bold text-slate-900"><?php echo e($appointment->character_name ?? 'N/A'); ?></span>
                            </div>
                        </div>
                        <div class="group p-5 bg-white/90 rounded-2xl border border-sky-100 hover:border-sky-200 transition-all duration-300 hover:shadow-md">
                            <div class="flex items-center justify-between">
                                ...
                                <span class="font-bold text-slate-900"><?php echo e($appointment->form_type ?? 'N/A'); ?></span>
                            </div>
                        </div>
                    </div>
                    <div class="space-y-4">
                        <div class="group p-5 bg-white/90 rounded-2xl border border-sky-100 hover:border-sky-200 transition-all duration-300 hover:shadow-md">
                            <div class="flex items-center justify-between">
                                ...
                                <span class="font-bold text-slate-900"><?php echo e($appointment->appointment_date ?? 'N/A'); ?></span>
                            </div>
                        </div>
                        <div class="group p-5 bg-white/90 rounded-2xl border border-sky-100 hover:border-sky-200 transition-all duration-300 hover:shadow-md">
                            <div class="flex items-center justify-between">
                                ...
                                <span class="font-bold text-slate-900"><?php echo e($appointment->appointment_time ?? 'N/A'); ?></span>
                            </div>
                        </div>
                        <div class="group p-5 bg-white/90 rounded-2xl border border-sky-100 hover:border-sky-200 transition-all duration-300 hover:shadow-md">
                            <div class="flex items-center justify-between">
            ...
            <div class="flex flex-col sm:flex-row gap-6 justify-center mb-8">
                ...
                <a href="<?php echo e(route('public.index')); ?>" class="group relative px-8 py-4 bg-white text-sky-600 text-lg font-bold rounded-2xl border-2 border-sky-500 shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300 overflow-hidden">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\website\EMS-IME\public_html\resources\views\public\appointment-success.blade.php ENDPATH**/ ?>