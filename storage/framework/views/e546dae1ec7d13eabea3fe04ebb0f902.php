        ...
        <div class="relative z-10 px-4 py-8 sm:px-6 lg:px-8 text-white">
            <div class="max-w-2xl mx-auto">
                ...
                <div class="glass-effect rounded-2xl elegant-shadow-lg p-8">
                    <form method="POST" action="<?php echo e(route('staff.register.post')); ?>" enctype="multipart/form-data"
                        class="space-y-6">
                        <?php echo csrf_field(); ?>
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <select id="hospital" name="hospital" required
                                    ...
                                    <option value="" disabled selected class="bg-slate-800 text-white font-bold">🏥 Pilih
                                        rumah sakit</option>
                                    <option value="alta" <?php if(old('hospital') == 'alta'): echo 'selected'; endif; ?>
                                        class="bg-slate-900 text-white font-bold">
                                        Alta Hospital (EMS)
                                    </option>
                                    <option value="roxwood" <?php if(old('hospital') == 'roxwood'): echo 'selected'; endif; ?>
                                        class="bg-slate-900 text-white font-bold">
                                        Roxwood Hospital
                                    </option>
                                </select>
