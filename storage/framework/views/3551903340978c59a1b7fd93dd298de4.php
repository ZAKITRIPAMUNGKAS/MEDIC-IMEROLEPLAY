            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-4">
                <div class="backdrop-blur-xl bg-white/10 border border-sky-400/30 rounded-2xl p-6 shadow-xl">
                    <div class="flex items-center justify-between mb-2">
                        ...
                        <h3 class="text-3xl font-bold text-white"><?php echo e($totalFeedback); ?></h3>
                    </div>
                ...
                <div class="backdrop-blur-xl bg-white/10 border border-blue-400/30 rounded-2xl p-6 shadow-xl">
                    <div class="flex items-center justify-between mb-2">
                        ...
                        <h3 class="text-3xl font-bold text-white"><?php echo e($newFeedback); ?></h3>
                    </div>
                ...
                <div class="backdrop-blur-xl bg-white/10 border border-red-400/30 rounded-2xl p-6 shadow-xl">
                    <div class="flex items-center justify-between mb-2">
                        ...
                        <h3 class="text-3xl font-bold text-white"><?php echo e($kritikCount); ?></h3>
                    </div>
                ...
                <div class="backdrop-blur-xl bg-white/10 border border-green-400/30 rounded-2xl p-6 shadow-xl">
                    <div class="flex items-center justify-between mb-2">
                        ...
                        <h3 class="text-3xl font-bold text-white"><?php echo e($saranCount); ?></h3>
                    </div>
...
[$__name, $__params] = $__split('feedback-list', []);

$key = null;

$key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-2211123097-0', null);
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\website\EMS-IME\public_html\resources\views/admin/feedback/index.blade.php ENDPATH**/ ?>