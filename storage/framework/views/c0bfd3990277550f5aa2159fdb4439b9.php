...
<div class="relative min-h-screen py-8 px-4 sm:px-6 lg:px-8">
    ...
    <div class="relative max-w-7xl w-full mx-auto text-white">
            ...
            <div class="flex flex-col space-y-4 sm:space-y-0 sm:flex-row sm:items-center justify-between mb-6">
                ...
                <div class="flex flex-col sm:flex-row items-start sm:items-center gap-4">
                    ...
                    <div class="flex flex-col sm:flex-row gap-3">
                        ...
                        <?php if(isset($canGenerateManually) && !$canGenerateManually): ?>
                            <button disabled
                            ...
                            <?php if(isset($lastWeekPayrollExists) && $lastWeekPayrollExists): ?>
            ...
            <form method="GET" action="<?php echo e(route('admin.payroll.index')); ?>" class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-6 gap-4">
                ...
                <div>
                    ...
                    <select name="paid_by" class="w-full bg-white/10 text-white border border-white/20 rounded-lg px-4 py-3 focus:ring-2 focus:ring-sky-400 focus:border-sky-400 appearance-none text-sm">
                        ...
                        <?php $__currentLoopData = $paidByUsers ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <?php if(isset($payrolls) && $payrolls->count() > 0): ?>
            <?php $__currentLoopData = $payrolls; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $weekStart => $weekPayrolls): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="flex items-center justify-between">
                            <div>
                                <h3 class="text-lg font-semibold text-white">
                                    ...
                                    <?php if($weekStart !== 'unknown' && !empty($weekStart)): ?>
                                        <?php
                                            try {
                                ...
                                <?php if($weekStart !== 'unknown' && $weekStart === now()->startOfWeek()->format('Y-m-d')): ?>
                    ...
                    <div class="overflow-x-auto">
                        <table class="min-w-full divide-y divide-white/10">
                            ...
                            <tbody class="divide-y divide-white/10">
                                <?php $__currentLoopData = $weekPayrolls; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $payroll): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php
