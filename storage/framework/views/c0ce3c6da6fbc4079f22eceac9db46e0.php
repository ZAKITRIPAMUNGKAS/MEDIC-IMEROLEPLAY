...
<?php $__env->startSection('title', 'Laporan & Analisis - Portal Medis MPK-BA'); ?>
            ...
            <div class="glass-effect rounded-2xl elegant-shadow-lg p-6 border-2 border-white/70">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-3xl font-bold text-white"><?php echo e($formStats['by_status']->sum('count') ?? 0); ?></p>
                        <!-- Debug: <?php echo e($formStats['by_status']); ?> -->
                    </div>
                </div>
            </div>
            ...
            <div class="glass-effect rounded-2xl elegant-shadow-lg p-6 border-2 border-white/70">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-3xl font-bold text-white"><?php echo e($formStats['by_status']->where('status', 'pending')->first()->count ?? 0); ?></p>
                    </div>
                </div>
            </div>
            ...
            <div class="glass-effect rounded-2xl elegant-shadow-lg p-6 border-2 border-white/70">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-3xl font-bold text-white"><?php echo e($formStats['by_status']->where('status', 'approved')->first()->count ?? 0); ?></p>
                    </div>
                </div>
            </div>
            ...
            <div class="glass-effect rounded-2xl elegant-shadow-lg p-6 border-2 border-white/70">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-3xl font-bold text-white"><?php echo e($formStats['by_status']->where('status', 'rejected')->first()->count ?? 0); ?></p>
                    </div>
                </div>
            </div>
        </div>
...
const leaderboardData = <?php echo json_encode($leaderboardData, 15, 512) ?>;
...
const statusData = <?php echo json_encode($formStats['by_status'], 15, 512) ?>;
...
const dailyData = <?php echo json_encode($formStats['daily'], 15, 512) ?>;
...
const formTypesData = <?php echo json_encode($formStats['by_type'], 15, 512) ?>;
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\website\EMS-IME\public_html\resources\views\staff\reports.blade.php ENDPATH**/ ?>