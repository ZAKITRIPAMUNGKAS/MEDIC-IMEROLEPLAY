                                ...
                                <div class="grid grid-cols-2 gap-3">
                                    <button type="button" wire:click="$set('feedbackType', 'saran')"
                                        class="px-4 py-3 rounded-xl border-2 text-sm font-medium transition-all
                                            <?php echo e($feedbackType === 'saran' ? 'border-green-500 bg-green-50 text-green-700' : 'border-slate-300 text-slate-600 hover:border-green-400'); ?>">
                                        <i class="fas fa-lightbulb mr-1"></i> Masukan
                                    </button>
                                    <button type="button" wire:click="$set('feedbackType', 'kritik')"
                                        class="px-4 py-3 rounded-xl border-2 text-sm font-medium transition-all
                                            <?php echo e($feedbackType === 'kritik' ? 'border-red-500 bg-red-50 text-red-700' : 'border-slate-300 text-slate-600 hover:border-red-400'); ?>">
