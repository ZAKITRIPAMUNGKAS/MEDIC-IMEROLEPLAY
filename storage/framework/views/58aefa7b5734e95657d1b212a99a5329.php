...
<body>
    ...
    <div class="swiper mySwiper">
        <div class="swiper-wrapper">
            ...
            <div class="swiper-slide" data-slide="hours">
                ...
                <div class="relative z-10 w-full max-w-md">
                    ...
                    <div class="glass-panel glass-highlight rounded-[2rem] p-8 text-center mb-4 relative overflow-hidden motion"
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($stats['total_hours'] == 0): ?>
                            <p class="text-xs text-white/40 mt-4">Belum ada data kehadiran untuk <?php echo e($year); ?></p>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    </div>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($stats['total_patients'] > 0): ?>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($stats['total_salary'] > 0): ?>
            ...
            <div class="swiper-slide" data-slide="badge">
                ...
                <div class="relative z-10 text-center px-6 max-w-sm">
                    ...
                    <h1 class="text-4xl font-bold text-grad-gold mb-6 leading-tight motion" data-delay="700">
                        <?php echo e($stats['badge']['primary']['title']); ?>
            ...
            <div class="swiper-slide" data-slide="outro">
                ...
                <div class="relative z-10 text-center px-6 w-full max-w-md">
                    ...
                    <div class="glass-panel p-8 rounded-[2rem] mb-6 relative overflow-hidden text-left motion"
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($quote['author']): ?>
                            <p class="text-right text-sm text-white/50 mt-4">
                                — <?php echo e($quote['author']); ?>
                    ...
                    <div class="mt-8 opacity-30 text-[10px] font-mono motion" data-delay="1300">
                        MedicIME Wrapped <?php echo e($year); ?> • Medical Center IME
                    </div>
    ...
    <script>
        ...
        function closeWrapped() {
            ...
            setTimeout(() => {
                fetch('<?php echo e(route("wrapped.dismiss")); ?>', {
                    method: 'POST',
                    headers: { 'Content-Type': 'application/json', 'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>' },
                    body: JSON.stringify({ year: <?php echo e($year); ?> })
                }).finally(() => {
                    sessionStorage.setItem('wrapped_<?php echo e($year); ?>_seen', 'true');
        ...
        function recordView() {
            ...
            fetch('<?php echo e(route("wrapped.record")); ?>', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json', 'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>' },
                body: JSON.stringify({ year: <?php echo e($year); ?> })
...
</html><?php /**PATH D:\website\EMS-IME\public_html\resources\views\wrapped\index.blade.php ENDPATH**/ ?>